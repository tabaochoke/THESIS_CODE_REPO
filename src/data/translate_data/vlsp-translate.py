...
if __name__ == '__main__':
    ...
    translate_vietnamese_to_english(vlsp_testset)
    vlsp_testset.to_csv('test_vlsp.csv', index=False)
    vlsp_testset.to_csv('../data/translated-sentiment-dataset/test_vlsp.csv', index=False)
